...
export default function DrawingToolbar({ activeTool, onToolChange, onClearAll }: DrawingToolbarProps) {
  ...
  return (
    <div className="absolute top-44 left-2 z-10 flex flex-col gap-1 bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-600/50 rounded-xl p-2 shadow-2xl backdrop-blur-sm max-h-[calc(100vh-200px)] overflow-y-auto">
      {/* Select Tool */}
      <button
