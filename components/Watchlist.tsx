...
export default function Watchlist({ onSymbolClick, currentSymbol, marketType = 'spot' }: WatchlistProps) {
  ...
  return (
    ...
    >
      ...
      <div
        className="hidden md:block absolute left-0 top-0 bottom-0 w-1 cursor-ew-resize hover:bg-blue-500 transition-colors z-50 group"
        onMouseDown={(e) => {
          e.preventDefault();
          setIsResizing(true);
        }}
          ...
          watchlist
            ...
            return (
              <div
                ...
                } ${dragOverSymbol === symbol ? 'ring-1 ring-blue-500/40' : ''}`}
              >
                <div className="flex items-center justify-between mb-0.5">
                  <div className="flex items-center gap-1.5">
                    <span className="text-gray-600 hover:text-gray-400 cursor-grab active:cursor-grabbing select-none">
                      ☰
                    </span>
                    <button
                      onClick={(e) => {
      ...
      {contextMenu && (
        <div
          className="fixed z-[9999] bg-gray-800 border border-gray-700 rounded-md shadow-lg p-1 text-sm text-gray-200 min-w-[180px]"
          ...
          {(() => {
            ...
            return (
              <div className="flex flex-col">
                ...
                >
                  Şu anki fiyata alarm kur {current ? `($${current.toFixed(current < 1 ? 4 : 2)})` : ''}
                </button>
                <button
                  className="text-left px-3 py-2 hover:bg-gray-700 rounded"
                  onClick={() => {
